...
- Lokalny Filesystem MCP startuje przez `npm run filesystem-mcp` i ma dostęp tylko do katalogu repo
- Lokalny MySQL MCP startuje przez `npm run mysql-mcp` po uzupełnieniu `.env`
